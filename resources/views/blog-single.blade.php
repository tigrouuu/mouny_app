                        ...
                        <div class="post-details">
                            <div class="main-content-head">
                                <div class="meta-information">
                                    <h2 class="post-title">
                                        <a href="{{ url('blog-single') }}">Web design refers to the design of websites
                                            that are
                                ...
                                <div class="post-thumbnils">
                                    <img src="{{ asset('images/blog-single.jpg') }}" alt="#">
                                </div>
                                <div class="detail-inner">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li><i class="lni lni-checkmark-circle"></i> The sad thing is the majority of
                                            people have
                                            no clue about what they truly want.
                                        </li>
                                ...
                                <ul class="comments-list">
                                    <li>
                                        <div class="comment-img">
                                            <img src="{{ asset('images/comment1.jpg') }}" alt="img">
                                        </div>
                                    ...
                                    <li class="children">
                                        <div class="comment-img">
                                            <img src="{{ asset('images/comment2.jpg') }}" alt="img">
                                        </div>
                                        <div class="comment-desc">
                                            <div class="desc-top">
                                    ...
                                    <li>
                                        <div class="comment-img">
                                            <img src="{{ asset('images/comment3.jpg') }}" alt="img">
                                        </div>
                                        <div class="comment-desc">
                                            <div class="desc-top">
                                                <h6>Alex Jemmi</h6>
